...
void TCP_client::connect(const std::string& host, const std::string& service,
		boost::posix_time::time_duration timeout)
{
	...
	{
		throw std::exception("A network connection attempt timed out.");
	}
	...
	boost::posix_time::time_duration timeout)
{
	...
	if (ec == boost::asio::error::operation_aborted)
	{
		throw std::exception("A network write operation timed out.");
	}
